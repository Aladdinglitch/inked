...
# Delete old components superseded by redesign
rm nocturne-tattoo/components/hero.tsx
rm nocturne-tattoo/components/navbar.tsx
rm nocturne-tattoo/components/footer.tsx
rm nocturne-tattoo/components/testimonial-card.tsx

# Delete old library files
rm nocturne-tattoo/lib/design-tokens.ts
```

**Estimated Savings**: ~1.5KB  
...
- [ ] Delete `nocturne-tattoo/components/hero.tsx`
- [ ] Delete `nocturne-tattoo/components/navbar.tsx`
- [ ] Delete `nocturne-tattoo/components/footer.tsx`
- [ ] Delete `nocturne-tattoo/components/testimonial-card.tsx`
- [ ] Delete `nocturne-tattoo/lib/design-tokens.ts`
