...
function FeatureCard({
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-2xl border border-gold/20 bg-gradient-to-br from-gold/8 to-gold/3 backdrop-blur-lg p-8 transition-all duration-500 group-hover:border-gold/40 group-hover:bg-gold/12 flex flex-col h-full">
