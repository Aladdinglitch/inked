      ...
      <div className="container grid grid-cols-1 gap-12 py-20 lg:grid-cols-[1.4fr_1fr_1fr_1.2fr]">
        <div>
          ...
          <p className="mt-5 max-w-xs text-sm leading-relaxed text-muted">
            Transform your ideas into timeless body art through custom tattoos and professional piercings crafted with precision, creativity, and uncompromising care. Every piece is uniquely designed to reflect your identity and leave a lasting impression.
          </p>
