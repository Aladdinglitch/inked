...
export const metadata: Metadata = {
  title: "Contact",
  description: "Get in touch with Inked Attraction — A tattoo and piercing studio with custom booking and support.",
};

const details = [
  { icon: MapPin, label: "Location", value: "Lagos, Lagos State, Nigeria" },
  { icon: Phone, label: "Phone", value: "+234 813 038-1326" },
  { icon: Mail, label: "Email", value: "towobolaelizabeth79@gmail.com" },
          ...
          <FadeUp>
            <div className="overflow-hidden rounded-xl2 border border-border">
              <div className="relative aspect-[16/10]">
                <Image
                  src="/images/Inked Attraction Tattoo Studio Emblem.png"
                  alt="Inked Attraction Tattoo & Piercing Studio emblem"
                  fill
                ...
                <div key={d.label} className="flex gap-4">
                  ...
                  <div>
                    ...
                    <dd className="mt-1 text-sm text-foreground">
                      {d.label === "Phone" ? <a href="tel:+2348130381326" className="hover:text-gold">{d.value}</a> : d.label === "Email" ? <a href="mailto:towobolaelizabeth79@gmail.com" className="hover:text-gold">{d.value}</a> : d.value}
                    </dd>
                  </div>
                </div>
              ))}
